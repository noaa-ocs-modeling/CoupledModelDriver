...
if __name__ == '__main__':
    ...
    nems = ModelingSystem(
        ...
        atm=AtmosphericMeshEntry('/work/07531/zrb/stampede2/forcings/shinnecock/wind_atm_fin_ch_time_vec.nc'),
        wav=WaveMeshEntry('/work/07531/zrb/stampede2/forcings/shinnecock/ww3.Constant.20151214_sxy_ike_date.nc'),
        ocn=ADCIRCEntry(382),
    )
