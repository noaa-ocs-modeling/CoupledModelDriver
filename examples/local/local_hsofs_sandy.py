...
MESH_DIRECTORY = Path(__file__).parent.parent / 'data' / 'input' / 'meshes' / 'hsofs' / 'sandy' / 'grid_v1'
...
FORCINGS_DIRECTORY = Path(__file__).parent.parent / 'data' / 'input' / 'forcings' / 'hsofs' / 'sandy'

# directory to which to write configuration
OUTPUT_DIRECTORY = Path(__file__).parent.parent / 'data' / 'configuration' / 'local_hsofs_sandy'
